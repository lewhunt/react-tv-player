...
The sample demo app illustrates how the component can be initialised with custom buttons and multiple media, which enables the user to cycle through media with next/previous buttons and handle actions such as the Like button.
...
| `customButtons` | Specify a collection of [custom buttons](#custom-buttons) for the player UI <br />&nbsp; ◦ &nbsp;A set of <a href="https://github.com/lewhunt/react-tv-player-vite/blob/b6c06bb760dbf16304b2f80603c1db7200a1187f/src/lib/TVPlayerUI/TVPlayerUI.tsx#L86-L92">default buttons</a> will be used otherwise.                          | `null`       |
